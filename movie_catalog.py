...
kill_bill = movie_data_structure.Movie("Kill Bill: Volume 1",
                "A former assassin wakes from a coma and sets off on her quest\
                for revenge.",
...
amelie = movie_data_structure.Movie("Amelie",
                    "A young woman who discretely orchestrates the lives of \
                    the people around her, creating a world exclusively of \
                    her own making.",
...
youve_got_mail = movie_data_structure.Movie("You've Got Mail",
                    "Two business rivals who hate each other in the office \
                    fall in love over the Internet.",
                    "https://upload.wikimedia.org/wikipedia/en/e/ee/You%27ve_Got_Mail.jpg",  # NOQA
...
# list of movies
movies = [toy_story, avatar, kill_bill, amelie,
          youve_got_mail, bourne_identity]
